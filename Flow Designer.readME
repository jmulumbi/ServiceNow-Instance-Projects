...
> Upload your screenshots to an `images/` folder in this repo and rename them to match the paths above, or update the paths to match your filenames.

| File | What to capture |
|---|---|
| `images/flow-overview.png` | Full canvas view of the approval flow |
| `images/flow-steps-1-4.png` | Trigger + high-priority branch (steps 1–4) |
| `images/flow-steps-9-13.png` | Standard approval path (steps 9–13) |
| `images/flow-list-view.png` | List view showing all 13 actions |
| `images/subflow-overview.png` | Full subflow canvas |
| `images/subflow-conditions.png` | The two If conditions (steps 2 & 4) |
| `images/subflow-for-each.png` | For Each loop + Update step (steps 7–8) |

---

*Built on the ServiceNow Now Learning platform as part of hands-on Flow Designer training.*
